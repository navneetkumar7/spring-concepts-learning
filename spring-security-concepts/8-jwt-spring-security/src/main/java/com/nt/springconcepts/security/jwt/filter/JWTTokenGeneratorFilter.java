package com.nt.springconcepts.security.jwt.filter;
...
public class JWTTokenGeneratorFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authentication != null) {
            ...
            String jwt = Jwts.builder().setIssuer("Test Bank").setSubject("JWT Token")
                    .claim("username", "jonh.doe@gmail.com")
        ...
        {
            log.info("-----------JWT generator authentication null");
        }
    ...
    /**
     * this method will be used to ensure  the jwt will be generated  for /register path only .
     *
     * @param request
     * @return
